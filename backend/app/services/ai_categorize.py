...
class AICategorizeService:
    ...
    async def generate_categories(db: AsyncSession) -> dict:
        ...
        prompt = (
            ...
            "- 'Boshqa' guruhida MAKSIMUM 3-4 ta kasb bo'lishi mumkin!\n"
            "- Menejerlarni 'Boshqaruv va Menejment' guruhiga qo'shing\n"
            "- Yordamchilarni tegishli sohaga qo'shing (masalan: Oshpaz yordamchisi → Oshxona)\n"
            "- Tibbiyot, Ta'lim, Dizayn, Huquq, Moliya — har biri ALOHIDA guruh bo'lsin\n"
            "- Logistika, Transport — alohida guruh\n"
            "- Savdo, Marketing — alohida guruh\n"
            "- Parent nomi guruhni aniq ifodalashi kerak\n"
            "- Kamida 15-20 ta guruh bo'lishi kerak (150+ kasb uchun)\n\n"
            "Javob formati:\n"
            "{\n"
            '  "groups": [\n'
            '    {\n'
